              ...
              <div class="txt-container">
                <div class="dropdown-txt hook-market-list">
                  ...
                  <el-tabs v-model="activeName" type="card" @tab-click="handleClick" class="trading-recode-tab">
                    <el-tab-pane :label="item.areaName" :name="item.areaName" v-for="(item,index) in marketList"
                                 :key="index">
                ...
                <div class="origin">
                  ...
                  <ul class="above">
                    <li v-for="(list,index) in depthsData.asks" :key="index"
                      ...
                      <div class="data-item">
                            <span>{{ $t('m.trade.sell') }}({{
                                (depthsData.asks.length - index) < 10 ? '0' + (depthsData.asks.length - index) : depthsData.asks.length - index
                              }})</span>
                        <span v-html="formatNumber(list.price,currentMarket.priceScale)" class="number-font"
                              style="text-align: center"></span>
                        <span v-html="formatNumber(list.volume,currentMarket.numScale)" class="number-font"
                  ...
                  <div class="middle">
                    ...
                    <a href="javascript:;"
                      ...
                      <select v-model="chooseMergeDepth" @change="subscribeDepths">
                        <option v-for="(item,index) in currentMarket.mergeDepth" :key="index"
                                v-bind:value="item.mergeType"
                ...
                <div class="wgt-transactor active" :class="{active:token}" id="hook-transactor-buy">
                  ...
                  <div class="list">
                    <div class="inputitem">
                      ...
                      <input type="text" v-model="currentBuyItem.price" @keyup="checkInputPrice('buy',$event)"
                             class="input hook-price">
                    </div>
                  </div>
                  <div class="list">
                    <div class="inputitem">
                ...
                <div class="wgt-transactor active" :class="{active:token}" id="hook-transactor-sell">
                  ...
                  <div class="list">
                    <div class="inputitem">
                      ...
                      <input type="text" v-model="currentSellItem.price" @keyup="checkInputPrice('sell',$event)"
                             class="input hook-price">
                    </div>
                  </div>
                  <div class="list">
...
export default {
  ...
  data() {
    return {
      currentMarket: {id: "SZ000068", title: '华控赛格', fulltitle: '--'},    //当前市场
      timeStp: 0,
      //选项卡
      turnoverTbData: [],    //成交记录
      entrustTbData: [],    //委托定单
