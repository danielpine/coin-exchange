          ...
          >
            ...
            <el-row class="grid-border-bottom">
              <el-row class="grid-row-content" v-for="(i, j) in 5" :key="i">
                <el-col :span="8"
                  ><div class="grid-content">卖{{ 6 - i }}</div></el-col
                >
                <el-col :span="8"
                  ><div
                    class="grid-content"
                ...
                <el-col :span="8"
                  ><div class="grid-content">
                    <div class="progressbar-wrapper">
                      ...
                      <div class="progressbar sell-bg" :style="getOrderBookItemPercent('ENTRY_SELL_' + (6 - i))"></div>
                    </div></div
                ></el-col>
              </el-row>
            </el-row>
            ...
            <el-row class="grid-border-top">
              <el-row class="grid-row-content" v-for="(i, j) in 5" :key="i">
                <el-col :span="8"
                  ><div class="grid-content">买{{ i }}</div></el-col
                >
                <el-col :span="8"
                  ><div
                    class="grid-content"
                ...
                <el-col :span="8"
                  ><div class="grid-content">
                    <div class="progressbar-wrapper">
                      ...
                      <div class="progressbar buy-bg" :style="getOrderBookItemPercent('ENTRY_BUY_' + i)"></div>
                    </div>
                  </div></el-col
                >
              </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      index: 0,
      eventLog: [],
      currentMarket: { symbol: "sh600519", title: "华控赛格" }, //当前市场
      timeStp: 0,
      //选项卡
      turnoverTbData: [], //成交记录
      entrustTbData: [], //委托定单
